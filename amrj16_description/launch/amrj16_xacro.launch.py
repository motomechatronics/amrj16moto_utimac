...
def generate_launch_description():
    ...
    pkg_box_bot_gazebo = get_package_share_directory('amrj16_gazebo')
    description_package_name = "amrj16_description"
    ...
    world_file_arg = DeclareLaunchArgument(
        ...
        default_value=[get_package_share_directory(
            'amrj16_gazebo'), '/worlds/amrj16_mechanical_workshop.world'],
   ...
   # Include the Gazebo launch file with the modified launch arguments
    ...
    robot_desc_file = "amrj16.xacro"
    robot_desc_path = os.path.join(get_package_share_directory(
        "amrj16_description"), "urdf", robot_desc_file)
    ...
    rviz_config_dir = os.path.join(get_package_share_directory(description_package_name), 'rviz', 'amrj16_rviz2_config.rviz')
